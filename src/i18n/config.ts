...
const resources = {
  fr: {
    translation: {
      ...
      "projects.pauseduchampion.desc": "Application mobile-first permettant de gérer ses temps de repos en musculation grâce à des minuteurs personnalisés et un suivi de la séance.",
      "projects.coffrette.desc": "Application mobile-first permettant de suivre ses dépenses et ses rentrées d’argent en liquide.",
  ...
  en: {
    translation: {
      ...
      "projects.pauseduchampion.desc": "Mobile-first application to manage rest times in bodybuilding with personalized timers and session tracking.",
      "projects.coffrette.desc": "Mobile-first application to track cash expenses and income.",
