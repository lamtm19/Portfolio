...
const resources = {
  fr: {
    translation: {
      ...
      "hero.subtitle": "Paris — 20 ans — École d'ingénieur en informatique Efrei Paris",
      "hero.cta": "Voir mes projets",
      "hero.download": "Télécharger CV & LM",
      ...
      "projects.pauseduchampion.desc": "Application mobile-first permettant de gérer et optimiser ses temps de repos en musculation grâce à des minuteurs personnalisés, un suivi des séances et une interface simple et intuitive, avec une estimation claire et visible du temps restant avant la fin de la séance.",
      "projects.coffrette.desc": "Application mobile-first permettant de suivre ses dépenses et ses rentrées d’argent en liquide, avec une vision claire de son argent disponible et un historique pour mieux gérer son budget au quotidien.",
  ...
  en: {
    translation: {
      ...
      "hero.subtitle": "Paris — 20 years old — Efrei Paris Engineering School",
      "hero.cta": "View my projects",
      "hero.download": "Download CV & CL",
      "skills.title": "Skills",
      ...
      "projects.pauseduchampion.desc": "Mobile-first application to manage and optimize rest times in bodybuilding with personalized timers, session tracking and a simple and intuitive interface, with a clear and visible estimation of the remaining time before the end of the session.",
      "projects.coffrette.desc": "Mobile-first application to track cash expenses and income, with a clear view of available money and a history to better manage your budget on a daily basis.",
